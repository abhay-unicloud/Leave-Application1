...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 02, 2024 at 08:44 AM
...
(1, 1, 'Abhay', 'Panwar', 1, 5, '2004-09-05', 'image/1712038978_img5.jpg', 'abhay@unicloudtech.com', '8955387379', '$2y$10$fgV5J2VRbWHVAWjcsz5KP.iz7nIum7Mq0Oio/r32aSu7jrrL3FVmO', '2024-04-02 00:52:58', '2024-04-02 00:52:58', 0);
...
INSERT INTO `employees` (`id`, `first_name`, `last_name`, `dpt_id`, `dst_id`, `dob`, `mobile_no`, `image`, `gender`, `addresses`, `email`, `password`, `status`, `created_at`, `updated_at`, `delete1`) VALUES
(1, 'Abhay', 'Panwar', 1, 5, '2004-09-05', '8955387379', 'image/1712038978_img5.jpg', 1, 'vbpc', 'abhay@unicloudtech.com', '$2y$10$k0fIRp3jQ87TVoRVBBQ8Ye7GY00QuYH/CFRMY8wdISygUoruVrOem', 0, NULL, NULL, 0);
...
INSERT INTO `leaves` (`id`, `emp_id`, `lt_id`, `start_date`, `end_date`, `reason`, `location`, `approval`, `comment`, `status`, `created_at`, `updated_at`, `delete1`) VALUES
(1, 2, '3', '2024-03-26', 0, 'sqa', 'sax', 2, 'life could be dream', 0, '2024-03-26 02:24:31', '2024-03-26 02:24:31', 0),
(2, 1, '1', '2024-03-26', 0, 'fsdf', 'sada', 1, 'cscac', 0, '2024-03-26 03:50:40', '2024-03-26 03:50:40', 0),
(3, 10, '8', '2024-03-28', 4, 'dsgvsd', 'fdsgv', 0, NULL, 0, NULL, NULL, 0),
(4, 5, '4', '2024-03-27', -1, 'bfg', 'bhdf', 0, NULL, 0, NULL, NULL, 0),
(5, 5, '1', '2024-03-27', 4, 'vz', 'vbz', 0, NULL, 0, NULL, NULL, 0);
...
(1, 'Casual Leave', 15, 0, NULL, NULL),
(2, 'Vacaton Leave', 15, 0, NULL, NULL),
(3, 'Marternity/Parentinity Leave', 15, 0, NULL, NULL),
(4, 'Family/Medical Leave', 15, 0, NULL, NULL),
(5, 'Study Leave', 15, 0, NULL, NULL),
(6, 'Special Leave', 15, 0, NULL, NULL),
(7, 'Military Leave', 15, 0, NULL, NULL),
(8, 'Administrative Leave', 15, 0, NULL, NULL),
(9, 'Stick Leave', 15, 0, NULL, NULL),
(10, 'Other Leave', 15, 0, NULL, NULL);
...
(1, 1, 'Abhay', 'Panwar', 1, 5, '2004-09-05', '8955387379', 'image/1712038978_img5.jpg', 1, 0, 0, NULL, NULL, 0);
