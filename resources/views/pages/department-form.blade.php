                    ...
                    <div class="statbox widget box box-shadow">
                        ...
                        <div class="widget-content widget-content-area m-1 p-2">
                            ...
                            <form action="{{route('add_depart')}}" method="POST">
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <label class="form-check-label" for="department">Add Department:</label>
                        ...
                        <a href="{{route('datatable-departments')}}"> <button class="btn btn-info mb-2 me-4">See Department</button> </a>
                    </div>
                </div>
            </div>
        </div>
