                                    ...
                                    <div class="widget-content widget-content-area m-1 p-2">
                                        <table id="style-3" class="table style-3 dt-table-hover">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td class="checkbox-column text-center"> {{$row->employee_id}} </td>
