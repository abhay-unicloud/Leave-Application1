                                                    ...
                                                    <form action="{{route('profile_update')}}" method="post">
                                                        ...
                                                        <div class="col-xl-2 col-lg-12 col-md-4">
                                                            <div class="profile-image  mt-4 pe-md-4">
                                                                ...
                                                                <input readonly type="hidden"value="{{ $empdata = Session::get('emp_data') }}">
                                                               
                                                                <input type="hidden" name="id" value="{{ $empdata->emp_id }}">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input readonly  type="text" class="form-control mb-3"
